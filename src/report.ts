...
export const validateSettings = util.validate(settingsSchema, {
  schemas: {
...
export const validatePage = util.validate(pageSchema);

export const validateFilter = util.validate(filterSchema, {
  schemas: {
    basicFilter: basicFilterSchema,
    advancedFilter: advancedFilterSchema
  }
