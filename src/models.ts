...
export const validateValueFilter = validate(valueFilterSchema);

export const validateAdvancedFilter = validate(advancedFilterSchema);
...
export interface IFilterColumnTarget extends IFilterTarget {
  column: string;
}

export interface IFilterHierarchyTarget extends IFilterTarget {
  hierarchy: string;
  hierarchyLevel: string;
}

export interface IFilterMeasureTarget extends IFilterTarget {
  measure: string;
}

export declare type ITarget = (IFilterColumnTarget | IFilterHierarchyTarget | IFilterMeasureTarget);
